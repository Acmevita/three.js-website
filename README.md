...
Earlier Three.js experiment exploring lighting, object positioning, and particles while following the tutorial. This scene is separate from the room demo currently in this repository:
